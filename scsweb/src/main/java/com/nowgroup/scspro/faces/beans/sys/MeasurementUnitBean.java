...
public class MeasurementUnitBean implements Serializable {
	...
	List<MeasurementUnit> source = measurementUnitServiceImpl.getMeasurementUnits();
	...
	try {
		...
		getMeasurementUnitServiceImpl().updateMeasurementUnit(measurementUnit);
	    } else {
		...
		getMeasurementUnitServiceImpl().addMeasurementUnit(measurementUnit);
	    }
	    return "success";
	} catch (Exception e) {
	    log.error(e.getMessage(), e);
	...
	List<MeasurementUnitRole> allRoles = measurementUnitRoleServiceImpl.getMeasurementUnitRoles();
